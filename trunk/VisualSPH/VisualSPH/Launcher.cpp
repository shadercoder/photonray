...
//    InitApp();
//
//    DXUTCreateWindow( L"SurfaceFire" );
...
//    WCHAR sz[100];
//    iY += 24;
//    swprintf_s( sz, 100, L"Scale: %0.2f", g_fModelPuffiness );
//    g_SampleUI.AddStatic( IDC_PUFF_STATIC, sz, 35, iY += 24, 125, 22 );
//    g_SampleUI.AddSlider( IDC_PUFF_SCALE, 50, iY += 24, 100, 22, 1, 2000, ( int )( g_fModelPuffiness * 100.0f ) );
//
//    iY += 24;
...
//    WCHAR str[MAX_PATH];
//	ID3D10Blob* pBlob = 0;
//    V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"SurfaceFire.fx" ) );
//    if( FAILED(D3DX10CreateEffectFromFile( str, NULL, NULL, "fx_4_0", dwShaderFlags, 0, pd3dDevice, NULL,
//		NULL, &g_pEffect, &pBlob, NULL ) ))
//	{
//		const char* message = (const char*)pBlob->GetBufferPointer();
//		MessageBoxA(0, message, "Shit happens", MB_OK);
//		return S_FALSE;
//	}
//
